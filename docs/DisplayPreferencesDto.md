...
**scroll_direction** | [**ScrollDirection**](ScrollDirection.md) | An enum representing the axis that should be scrolled. | [optional] 
...
**sort_order** | [**SortOrder**](SortOrder.md) | An enum representing the sorting order. | [optional] 
